...
function validarFormulario(e) {
  ...
  const teminoBusqueda = document.querySelector('#termino').value;
...
function buscarImagenes() {
  ...
  const key = '25885586-e81a575354fea6ff41d28b86c';
...
// generador que va a regustrar la cantidad de elementos de acuerdo a las paginas
...
function mostrarImagenes(imagenes) {
  ...
  imagenes.forEach((imagen) => {
    const { webformatURL, previewURL, likes, views, largeImageURL } = imagen;

    resultado.innerHTML += `
    <div class="w-1/2 md:w-1/3 lg:w-1/4 p-3 mb-4">
        <div class="bg-white max-w-">
