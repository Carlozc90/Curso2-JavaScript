...
// Lee el contendido del HTML al que le dimos click y estrae la informacion del curso
  ...
  if (existe) {
    ...
    const cursos = articulosCarrito.map((curso) => {
      if (curso.id === infoCurso.id) {
        curso.cantidad++;
        return curso; // retorna el objeto actializado
      } else {
